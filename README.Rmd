...
Often researchers need to compute the VGVI for a large study area, therefore we have provided a sample workflow for the City of Vancouver. Since this workflow is extensive, we have uploaded it on an external website (will be published on 6.7.2021).

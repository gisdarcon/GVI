...
If the `remotes` has not been installed yet, install the released version of remotes from CRAN:
``` r
...
The `visualizeWeights()` function helps setting the parameters *m* and *b*.
...
```{r echo=FALSE}
# Delete raw DSM and GreenSpace files
